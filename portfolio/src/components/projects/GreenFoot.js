  ...
  return (
    <>
      <ProjectsComp
        ...
        body={
          <Carousel className="pb-3" interval={null} indicators={true}>
            {images.map((imgs) => (
      ...
      <ProjectModal
        ...
        description="Fighting Kimmy is a game developed using Greenfoot API (Java). The project consists of actors, colors, fonts, images, 
        sounds, world, mouseinfo, and userinfo. The projects inspiration is from Kimmy, a mobile legends character. 
